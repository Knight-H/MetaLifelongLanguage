            ...
            for adapt_idx, (text, labels) in enumerate(support_set):
                ...
                if((adapt_idx + 1) % 5 == 0):
                    ...
                    with torch.no_grad():
                        ...
                        class_diff_dict = calculate_diff_class(all_valid_labels_0, all_valid_label_conf_0, all_valid_label_conf_n, valid_class_diff.get(adapt_idx+1, {}))
...
for test_dataset in test_datasets:
    ...
    valid_label_conf_filename = _model_path0 + "_update"+ str(updates) +"_valid_label_conf_sr_ta4_" + test_dataset.__class__.__name__ + ".pickle"
    ...
    _model_path0 = os.path.splitext(model_path)[0]
    valid_class_diff_filename = _model_path0 + "_update"+ str(updates) +"_valid_class_diff_sr_ta4_" + test_dataset.__class__.__name__ + ".pickle"
...
_model_path0 = os.path.splitext(model_path)[0]
time_txt_filename = _model_path0 + "_update"+ str(updates) +"_time_inference_sr_ta4_es.csv" 
...
# Log Valid Set
_model_path0 = os.path.splitext(model_path)[0]
valid_csv_filename = _model_path0 + "_update"+ str(updates) +"_valid_results_sr_ta4_es.csv" # for selective replay
