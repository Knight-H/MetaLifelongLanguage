...
if __name__ == '__main__':
    ...
    parser.add_argument('--memory_path', type=str, help='Memory Path of model')
    ...
    # Selective Replay
    parser.add_argument('--selective_replay', type=bool, help='Selective Replay or normal Replay', default=False)
    # Custom PLN
    ...
    for dataset_id in data_order:
        ...
        # KNIGHT EDIT TO MAKE IT LOAD TESTING DATA FAST!
        test_dataset_file = os.path.join(args.cache_dir, f"test-{dataset_id}.cache")
...
#     memory_path = "/data/model_runs/original_oml/OML-order1-id4-2022-07-18_17-53-13.518639_memory.pickle"
#     memory_path = "/data/model_runs/original_oml/OML-order1-id3-2022-07-18_17-22-11.802318_memory.pickle"
